...
3. Run the Docker Compose stack:
   ...
   ```
4. Visit the VM's public IP address `https://duolingo-ujjwal.duckdns.org`. *Note: The FastAPI backend will automatically seed the SQLite database on startup if it detects an empty database.*
